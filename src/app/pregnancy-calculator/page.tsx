        ...
        >
            <div className="space-y-6">
                <div className="space-y-2">
                    ...
                    <input
                        type="date"
                        className="w-full h-12 rounded-xl border bg-background px-4 font-bold outline-none focus:border-teal-400 transition-all"
                        value={lmp}
            ...
            <div className="space-y-6">
                <div className="bg-teal-500/5 rounded-3xl p-8 border border-teal-500/10 text-center">
                    <p className="text-sm font-bold text-teal-500 mb-1 uppercase tracking-wider">Estimated Due Date</p>
                    <p className="text-4xl md:text-5xl font-black text-teal-600 dark:text-teal-400">
                        {dueDate}
                    </p>
